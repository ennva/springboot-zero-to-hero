...
import org.ennva.GithubProperties;
...
public class GithubClient {
	...
	public ResponseEntity<RepositoryEvent[]> fetchEvents(String orgName, String repoName){
		...
		log.info("FETCH URL: " +  EVENT_ISSUES_URL.replace("{owner}", orgName).replace("{repo}", repoName));
	...
	private static class GithubAppTokenInterceptor implements ClientHttpRequestInterceptor {
		...
		public ClientHttpResponse intercept(HttpRequest httpRequest, byte[] bytes,
			...
			log.info("TOKEN INTERCEPTED: " +  this.token);
